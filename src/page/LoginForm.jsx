    ...
    <div className='main'>
      <form className="form_main" onSubmit={handleLoginClick}>
        ...
        <div className="inputContainer">
          ...
          <input value={username} placeholder="Tên đăng nhập" id="username" className="inputField" type="text" onChange={(e) => setUsername(e.target.value)} />
        </div>
        <div className="inputContainer">
          <FontAwesomeIcon className="inputIcon" icon={faLock} />
          <input value={password} placeholder="Mật khẩu" id="password" className="inputField" type="password" onChange={(e) => setPassword(e.target.value)} />
        </div>
